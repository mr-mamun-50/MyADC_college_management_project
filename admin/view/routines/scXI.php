<div class="row">
    ...
    <div class="col-lg-2 mb-3 col-sm-4">
        <a class="btn btn-primary w-100" href="printable_files/routine_print_xi.php?status=print_routine&&dept=sc" target="blank" style="padding: 0.65rem;"><i class="fas fa-print"></i> Print</a>
    </div>
</div>
...
<?php while ($routineXISC = mysqli_fetch_assoc($routineDataXI)) { ?>
    ...
    <tr>
        ...
        <td class="text-center"><a class="btn btn-primary btn-sm" href="edit_routine_xi.php?status=edit_routine_xi&&id=<?php echo $routineXISC['ID']; ?>&&dept=sc"><i class="fas fa-edit"></i></a></td>
    </tr>
