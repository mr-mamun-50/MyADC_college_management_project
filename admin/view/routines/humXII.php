<div class="row">
    ...
    <div class="col-lg-2 mb-3 col-sm-4">
        <a class="btn btn-primary w-100" href="printable_files/routine_print_xii.php?status=print_routine&&dept=hum" target="blank" style="padding: 0.65rem;"><i class="fas fa-print"></i> Print</a>
    </div>
</div>
...
<?php while ($routineXIIHUM = mysqli_fetch_assoc($routineDataXII)) { ?>
    ...
    <tr>
        ...
        <td class="text-center"><a class="btn btn-primary btn-sm" href="edit_routine_xii.php?status=edit_routine_xii&&id=<?php echo $routineXIIHUM['id']; ?>&&dept=hum"><i class="fas fa-edit"></i></a></td>
